...
def menuFunction():
    ...
    print()
    print('Type a number below to continue')
    if previousSaves == False:
        ...
        if menuInput == '1':
            ...
            print()
            print()
            print('Do you want to enable Speedrun Mode? (This makes text scroll instantly)')
            userInput = input()
            if userInput == 'yes' or userInput == 'Yes':
                speedrunMode()
            else:
                print()
                print(' - Speedrun Mode Remains Disabled - ')
                print('Returning to Menu...')
                print()
                time.sleep(3)
                menuFunction()
            ...
            print()
            print('You did not type a valid number, returning to menu')
            print()
            print()
            menuFunction()
...
if newGame == True:
    ...
    print()
    print()
    print("You struggle to open your eyes")
    time.sleep(sleepWaitShort)
    ...
    while villageQ:
        ...
        if userInput == 'yes' or userInput == 'Yes':
            ...
            while treeRest:
                if userInput == 'yes' or userInput == 'Yes':
                    print()
                    print('You sit down underneath a tree')
                    time.sleep(sleepWaitShort)
                    print('Nice and dry')
                    time.sleep(sleepWaitMedium)
            ...
            print()
            print("You decide against going to the village and take shelter under a big rock")
            time.sleep(sleepWaitMedium)
            ...
            while bearQuestion:
               ...
               if userInput == 'attack' or userInput == 'Attack':
                  ...
                  print()
                  print('You stand still as you stare him down')
                  time.sleep(sleepWaitShort)
    ...
    writeFile.write('Gender : ' + characterGender + '\n')
    writeFile.close()
...
if continueGame == True:
    ...
    with open('save.txt', 'r') as Readfile:
        ...
        savedGender = Readfile.readline()[9:]
        time.sleep(2)
